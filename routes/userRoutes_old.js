...
router.post('/register', async (req, res) => {
  try {
    ...
    const registration = await sql`
      INSERT INTO individual_registrations (event_id, event_name, name, email, mobile, roll_no, year, branch, college, transaction_id, screenshot_url, payment_status)
      VALUES (${eventId}, ${eventName}, ${name}, ${email}, ${mobile}, ${rollNo}, ${year}, ${branch}, ${college}, ${transactionId}, ${screenshotUrl}, 'completed')
      RETURNING *
    `;
...
router.post('/register-team', async (req, res) => {
  try {
    const { teamName, teamLeader, members, eventId, eventName, transactionId } = req.body;
    ...
    const registration = await sql`
      INSERT INTO team_registrations (
        ...
        transaction_id, amount, payment_status
      )
      VALUES (
        ...
        ${transactionId}, ${amount}, 'completed'
      )
      RETURNING *
    `;
